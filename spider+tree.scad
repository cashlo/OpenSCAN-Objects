...
maximum_branching_iterations = 4; //[1,2,3,4,5,6,7]

//The radius of the bottom of the trunk of the tree in mm
trunk_radius = 20; //[10:35]
...
stop_budding_position = 90; //[0:100]
...
use_advanced_settings = 1; //[0:No,1:Yes]
