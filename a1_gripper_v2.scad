...
module plate() {
    difference() {
        left(8)
        cuboid([plate_x+50, plate_y, plate_z], rounding=plate_r, edges="Y");
...
module servo_slot() {
    ...
    right(12)
    difference() {
        cuboid([25+8+25+4, 42.5, 45.5+8], anchor=BACK, rounding=plate_r/2, edges="Y");
        
        left(25/2+2){
            cuboid([25, 40.5, 45.5], anchor=BACK);
            
            fwd(40.5)
            down(45.5/2-10)
            ycyl(20, d=41, anchor=BACK);
        }
        ...
        fwd(40.5)
        hull(){
            cuboid([25+2, 0.01, 45.5+2], anchor=BACK);
            back(1)
            cuboid([25, 0.01, 45.5], anchor=BACK);
        }
